        ...
        <div className="dialog-body">
            ...
            {tab === 'execution' && <div className="form-stack">
                ...
                {draft.retailResponseMode === 'target' && <>
                    ...
                    <div className="inline-note"><Gauge size={17}/><span>0 = take no action. Negative (e.g. -0.1) = add holding wallets one by one until selling them pushes the price to the retail average buy price × (1 - 10%), then execute the batch; pump buys pause while retail still holds. Positive (e.g. 0.1) = buy just enough to lift the price to average × (1 + 10%). A profitable retail buy still exits everything immediately.</span></div>
                </>}
